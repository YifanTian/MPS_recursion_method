...
axs[0].text(20,0.15,'U=2',fontsize=14)
axs[1].text(20,0.15,'U=4',fontsize=14)
axs[2].text(20,0.15,'U=8',fontsize=14)
...
# plt.savefig('{}_{}_mul{}_int{}_start_{}_diff_U.pdf'.format(file_name, case, muti_num, interval_step, start_time))
plt.show()